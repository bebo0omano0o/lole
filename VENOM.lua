...
{
{text = 'اضف '..Namebot..' الي مجموعتك' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"},
},
}
...
{
{text = 'اضف "..N.." لمجموعتك', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,'𖥔 رتبتك 「 '..rtp..' 」 \n  √') 
end
