...
{
{text = '𖥔 اضغط لاضافه البوت لمجمعتك 𖥔' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"},
},
}
...
{
{text = '𖥔 اضغط لاضافه البوت لمجمعتك 𖥔', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == "ترتيب الاوامر" and Constructor(msg) then
 ...
 send(msg.chat_id_, msg.id_,"𖥔 تم ترتيب الاوامر بالشكل التالي\n𖥔 ايدي - ا .\n𖥔 مميز - م .\n𖥔 ادمن - اد .\n𖥔 مدير - مد . \n𖥔 منشى - من .\n𖥔 المنشئ الاساسي - اس .\n𖥔 تعطيل الايدي بالصوره - تعط .\n𖥔 تفعيل الايدي بالصوره - تفع .\n𖥔 تنزيل الكل - تك .\n𖥔 اضف رد - رد .\n𖥔 حذف رد - حذ .\n𖥔 تثبيت - ت .")
 end
...
database:set(bot_id.."Add:Rd:Sudo:stekr"..test, msg.content_.sticker_)  
send(msg.chat_id_, msg.id_,' ستيكر')
end   
if msg.content_.voice_ then  
database:set(bot_id.."Add:Rd:Sudo:vico"..test, msg.content_.voice_)
send(msg.chat_id_, msg.id_,' صوت 2')
end   
if msg.content_.animation_ then   
database:set(bot_id.."Add:Rd:Sudo:Gif"..test, msg.content_.animation_)
send(msg.chat_id_, msg.id_,' متحركه')
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
send(msg.chat_id_, msg.id_,' كلام')
end  
if msg.content_.audio_ then
database:set(bot_id.."Add:Rd:Sudo:Audio"..test, msg.content_.audio_)  
send(msg.chat_id_, msg.id_,' صوت')
end
if msg.content_.document_ then
database:set(bot_id.."Add:Rd:Sudo:File"..test, msg.content_.document_)  
send(msg.chat_id_, msg.id_,' ملف')
end
if msg.content_.video_ then
database:set(bot_id.."Add:Rd:Sudo:Video"..test, msg.content_.video_)  
send(msg.chat_id_, msg.id_,' فيديو')
end
if msg.content_.photo_ then
send(msg.chat_id_, msg.id_,' صوره')
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
send(msg.chat_id_, msg.id_,' صوره ب 0')
end
if msg.content_.photo_.sizes_[1] then
photo_in_group = msg.content_.photo_.sizes_[1].photo_.persistent_id_
send(msg.chat_id_, msg.id_,' صوره ب 1')
end
if msg.content_.photo_.sizes_[2] then
photo_in_group = msg.content_.photo_.sizes_[2].photo_.persistent_id_
send(msg.chat_id_, msg.id_,' صوره ب 2')
end	
if msg.content_.photo_.sizes_[3] then
photo_in_group = msg.content_.photo_.sizes_[3].photo_.persistent_id_
send(msg.chat_id_, msg.id_,' صوره ب 3')
end
database:setbot_id.."Add:Rd:Sudo:Photo"..test, photo_in_group)  
send(msg.chat_id_, msg.id_,' صوره حفظ')
end
send(msg.chat_id_, msg.id_,' 𖥔 تم حفظ الرد')
return false  
end  
send(msg.chat_id_, msg.id_,' تتتتتتتتتتتتتتتتت')
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' 𖥔 هذا الامر خدد ليس لك\n  اكتب 「اوامر الاعضاء」لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
