...
if text == '/start' and Devban(msg) then 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qtdao/31&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قـسم الـسورس' and Devban(msg) then 
...
if text == 'قـسم مـسح&اضـف' and Devban(msg) then 
...
if text == 'قـسم تـفعيل&تـعطيل' and Devban(msg) then 
...
if text == 'قـسم الـحمايه' and Devban(msg) then 
...
if text == 'قـسم الاذاعـه' and Devban(msg) then 
...
send(msg.chat_id_, msg.id_,' 𖥔 اصدار سورس فينوم{ S:12✓}')
end
...
if text == '• ━━━━━━❪الركن الاخير❫━━━━━━ •' and Devban(msg) then
local Text = [[ 
[قناه سورس فينوم ادخل وتابع الجديد](t.me/SOURCEVENOM)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == '• ━━━━━━❪الاقسام❫━━━━━━ •' and Devban(msg) then
local Text = [[ 
[قناه سورس فينوم ادخل وتابع الجديد](t.me/SOURCEVENOM)
]] 
keyboard = {}  
...
send(msg.chat_id_, msg.id_," 𖥔تـم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖥔 تـم تـعـطـيل انا مين") 
return false end
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SOURCEVENOM)')
return false
end

if text == 'انا مين' and Devban(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖥔انا مين معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SOURCEVENOM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SOURCEVENOM)')
return false
end
...
faederdx(msg.chat_id_, msg.id_, 1, '️𖥔جلب الصوره الشخصيه معطل ،', 1, 'md')
else
if pronumb[2] == '1' then
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, "𖥔لا تمتلك صوره في حسابك  ", 1, 'md')
end
elseif pronumb[2] == '2' then
if result.photos_[1] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[1].sizes_[1].photo_.persistent_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '️𖥔انت لا تمتلك الصوره التي طلبت رقمها ،', 1, 'md')
end
...
faederdx(msg.chat_id_, msg.id_, 1, "𖥔لا يمكنني ان ارسل لك اكثر من 10 صور ", 1, 'md')
end end end
tdcli_function ({
...
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖥔نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 🌚💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
