...
keyboard.inline_keyboard = {
{
{text = 'ابدا العب', callback_data=msg.sender_user_id_.."/guitar"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if Text and Text:match('(.*)/guitar')  then
if tonumber(Text:match('(.*)/guitar')) == tonumber(data.sender_user_id_) then
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(arg,data)
local Teext =[[
شيء لا يمشي إلا بالضرب فمن يكون؟
]]
keyboard = {} 
...
keyboard.inline_keyboard = {
{
{text = '𖥔??𝙰𝙲𝙺↵', callback_data="/help8"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Text)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
