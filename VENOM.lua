...
keyboard.inline_keyboard = {
{
{text = 'الروابط'..info, callback_data='amr@'..user..'/user@'..user_id.."/chenginfo"..lock_links},
},
{
{text = 'المعرفات '..delete, callback_data='amr@'..user..'/user@'..user_id.."/delmsgg"..lock_user},
},
{
{text = 'التاك '..restrict, callback_data='amr@'..user..'/user@'..user_id.."/VNOuser"..lock_hash},
},
{
{text = 'البوتات..invite, callback_data='amr@'..user..'/user@'..user_id.."/addlink"..lock_bots},
},
{
{text = 'تثبيت الرسائل '..pin, callback_data='amr@'..user..'/user@'..user_id.."/pinmsg"..pinn},
},
...
local Texti = '𖥔 اعدادات الجروب كتالي √\n⩹━━━━「𝐕𝐄𝐍𝐎𝐌」━━━━⩺\nعلامة ال {✓} تعني مفعل \nعلامة ال {✘} تعني معطل' 
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..chat..'&text='..URL.escape(Texti)..'&message_id='..msgid..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
